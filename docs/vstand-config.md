...
### Настройки grafana
Для доступа к grafana **при первом запуске** в конфигурационном файле настраивается login и пароль. Если они не указаны, то будут использованы логин и пароль пользователя под котороым
