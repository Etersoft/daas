...
После того, как виртуальный стенд запущен и настроен. В gitlab зарегистрированы
...
Его логин и пароль вносятся в [конфигурационный файл для стенда](docs/vstand-config.md) на этапе настройки.
